...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route ('admin.dokter') }}" class="logo d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <div>
        <a class="btn btn-success" href="{{ route('admin.tambah') }}" style="text-decoration: none;">Tambah Data +</a>    
    </div>

  </main>
  <body>
  <table class="table" style="width: 74%; border-collapse: collapse; left: 10px; margin-left: 310px">
        <thead>
            <tr>
                <th scope="col">No</th>
        ...
        @foreach ($data as $dokter)
          <tr>
              ...
              <td>
                <img style="width: 150px" src="{{ asset('/images/' . $dokter->gambar) }}" alt="foto dokter">
              </td>
              <td>{{ $dokter->name }}</td>
              <td>{{ $dokter->email }}</td>
            ...
            <td>
              <a class="btn btn-outline-warning" href="/admin/editDokter/{{ $dokter->id }}">Edit</a>
              <a class="btn btn-outline-danger" href="/admin/deleteDokter/{{ $dokter->id }}">Delete</a>
            </td>
          </tr>
        @endforeach
