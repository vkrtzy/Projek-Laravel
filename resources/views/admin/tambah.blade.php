                        ...
                        <div class="card mt-4" style="width: 800px">
                            <div class="card-body">
                              <div  href="{{ route('admin.dokter') }}" >
                                ...
                                <form action="{{ route('postTambahDokter') }}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="form-group mt-4">
                                        <label class="text-secondary mb-2">Nama</label>
                                        <input class="form-control border border-secondary form-control" name="name" required value="{{ old('name') }}" type="text" >
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input class="form-control border border-secondary form-control" name="email" required value="{{ old('email') }}" type="text" >
                                        <span class="text-danger">
                                            @error('email')
                                              {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <input class="form-control border border-secondary form-control" name="spesialis" required value="{{ old('spesialis') }}" type="text">
                                        <span class="text-danger">
                                            @error('spesialis')
                                              {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="form-text">Maksimal ukuran foto dokter 5MB
                                        <span class="text-danger">
                                            @error('gambar')
                                              {{ $message }}
                                            @enderror
                                    ...
                                    <button type="submit" class="btn btn-success mt-5" ">Tambah Data Dokter </button>
                                </form>
                            </div>
                        </div>
                    </div>
